...
namespace MedicineScheduler.DataAccessLayer.Migrations
{
    ...
    [Migration("20230802070718_AddGeneratedColumnPriceTotal")]
    partial class AddGeneratedColumnPriceTotal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedicineScheduler.DataAccessLayer.Entities.Order", b =>
                {
                    ...
                    b.Property<double>("PriceTotal")
                        ...
                        .HasPrecision(9, 2)
                        .HasColumnType("REAL")
                        .HasComputedColumnSql("QuantityPackages * PricePerPackage", true);
